...
import { Home, Calendar, Siren, ShoppingBag, BarChart3, Settings } from "lucide-react";
...
export function FloatingBottomNav() {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 glass-strong rounded-full px-1.5 py-2 flex items-center gap-0.5 shadow-2xl max-w-[calc(100vw-1.5rem)]"
    >
      {items.map((it) => {
        ...
        return (
          <Link
            ...
            to={it.to}
            className={cn(
              "relative flex flex-col items-center justify-center rounded-full px-2.5 py-2 min-w-[50px] transition-colors",
